...
cmd = 'fslmaths ' + atlas_space_tracts[0] + ' -add ' + atlas_space_tracts[1] + ' -add ' + atlas_space_tracts[2] + ' -add ' + atlas_space_tracts[3] + ' -add ' + atlas_space_tracts[4] + ' -add ' + atlas_space_tracts[5] + ' -add ' + atlas_space_tracts[6] + ' -add ' + atlas_space_tracts[7] + ' /cubric/data/c1639425/Monkey_Brains/probability_mask_subic_8_subs'
...
cmd = 'fslmaths ' + atlas_space_tracts[0] + ' -add ' + atlas_space_tracts[1] + ' -add ' + atlas_space_tracts[2] + ' -add ' + atlas_space_tracts[3] + ' -add ' + atlas_space_tracts[4] + ' -add ' + atlas_space_tracts[5] + ' -add ' + atlas_space_tracts[6] + ' -add ' + atlas_space_tracts[7] + ' -add ' + atlas_space_tracts[8] + ' /cubric/data/c1639425/Monkey_Brains/subic_probtract_probability_mask'

...
# This script will register an atlas to a monkey brain in native space. 
...
# subj_folders and subj_ids needs to be a list of the folders of each subjects where your b0 images are, and a list of the subject names. The folders and subject names lists should match exactly in terms of their order. E.g. subj_folders[0] = /my/folder/subj-01 and subj_names[0] = subj-01. 
...
subj_ids = [x[48:54] for x in subj_folders] # Change this to 'catch' the subject IDs
print(subj_ids)
# print(subj_folders)
...
file_extension = '_dwi_bet_shuffled_FP.nii' # this is the file extension after you have got the data ready for tractography via Explore DTI
